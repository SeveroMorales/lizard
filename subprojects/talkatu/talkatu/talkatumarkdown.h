...
#ifndef TALKATU_MARKDOWN_H
#define TALKATU_MARKDOWN_H
...
void talkatu_markdown_insert(TalkatuBuffer *buffer, GtkTextIter *iter, const gchar *text, gint len);

G_END_DECLS

#endif /* TALKATU_MARKDOWN_H */
